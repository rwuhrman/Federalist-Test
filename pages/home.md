...
hero-text:  {% raw %}"{% endraw %}In order to improve the way government delivers services externally, we need to aggressively reform the way government delivers service internally." - Cross Agency Priority Goal for Shared Services
